...
test('jest-wrap', function (t) {
	...
	t.test('no transformations', function (st) {
		...
		st['throws'](function () { wrap().test('foo', function () {}); }, RangeError, 'throws when there are no transformations');
		st['throws'](function () { wrap().it('foo', function () {}); }, RangeError, 'throws when there are no transformations');
		st.end();
	});

	t.test('{describe,test,it}.{skip,only} throw', function (st) {
		...
		st['throws'](function () { wrap().test.skip('skip'); }, SyntaxError, 'test.skip throws');
...
test('JestWrapper', function (t) {
	...
	t.test('#use()', function (st) {
		st.test('borrowing on a non-wrapper', function (sst) {
			sst['throws'](function () { instance.use.call({}, function withFoo() {}); }, TypeError, 'throws when receiver is not JestWrapper');
			sst.end();
		});
